...
if (isset($_GET['id_pedido'])&&isset($_GET['apellido'])&&isset($_GET['nombre'])&&isset($_GET['direccion'])) {
    if ($pedidos->setId_Pedido($_GET['id_pedido'])) {
        if ($dataPedido = $pedidos->readOrderDetail()) {
