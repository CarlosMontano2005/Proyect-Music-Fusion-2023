...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/proyect-music-fusion-2023/views/dashboard/';
    ...
    */
    public function header()
    {
        ...
        $this->image('../../img/logos/logo.png', 15, 15, 20);
        // Se ubica el título.
        ...
        // $this->cell(0, 10, $_SESSION['alias_usuario'], 0, 1, 'C');
